...
DIAGNOSTIC_KEYS = (
    ...
    "locatorAgreementCount", "positionUncertaintyKm",
    "parfittF", "parfittSupport", "parfittSupportFraction",
    "wndChangeMs6h", "wndTurnDeg", "wndSupport", "wndSupportFraction",
    "wndColdSupportFraction", "mlFrontProbability",
